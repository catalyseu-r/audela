  ...
  return (
    ...
    >
      <SearchIcon
        ...
        } text-main-white text-2xl cursor-pointer transition-all ease-in-out hover:text-interactive-green`}
      />

      <div
        className={` transition-all duration-500 origin-right ${
          isSearchActive ? 'w-full scale-x-100' : 'w-0 scale-x-0'
