          ...
          {relatedItems.map((item, index) => {
            return (
              <Link
                ...
                className='snap-always snap-center select-none group '
              >
                <div
                  draggable={false}
                  className=' relative rounded   md:w-[28rem] md:h-[20rem] w-[calc(45vw+2rem)] h-56 aspect-square   overflow-hidden select-none snap-always snap-center'
                >
                  <Image
                    className='rounded aspect-square bg-deep-green/30 animate-pulse object-center select-none group-hover:-translate-y-1/4 group-hover:scale-125 group-hover:blur-sm  transition-all duration-300 ease-custom-anim delay-200 pointer-events-none'
                    objectFit='cover'
                    fill
                    loading='lazy'
                  ...
                  <div
                    ...
                    className='absolute md:-bottom-full bottom-0 group-hover:bottom-0 transition-all duration-300 ease-custom-anim  lg:px-6 px-3 py-4  w-full md:h-40 h-32 grid items-end grid-cols-1 justify-between lg:bg-text-white bg-text-white/80 '
                  >
